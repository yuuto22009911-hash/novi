  ...
  return (
    <article className="flex max-w-3xl flex-col gap-[clamp(2rem,5vw,3rem)]">
      <header className="mb-[clamp(1rem,4vw,3rem)] flex flex-col gap-2">
        <h1 className="text-3xl font-medium tracking-tight">{tactile.label}</h1>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">Raster とどう違うか</h2>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">指が届くことを実測しています</h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          対話要素の
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">入力の文字は 16px を下回りません</h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          iOS Safari は 16px 未満の入力欄にフォーカスすると
          <strong className="font-medium text-site-fg">ページごと拡大し、以後戻りません</strong>。
          <code className="font-mono text-[0.875em]">size=&quot;sm&quot;</code>{' '}
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">影は面にも使います</h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          階層は<strong className="font-medium text-site-fg">持ち上がり</strong>で作ります （Raster
          は線で切ります）。境界線は補助的にしか使いません。
          <code className="font-mono text-[0.875em]">lg</code> だけ影が上向きなのは、
          浮く面が画面の下端から来るためです。
        </p>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">中立色まで選んだ色に染まります</h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          Tactile は<strong className="font-medium text-site-fg">染まる生地</strong>です。
          <code className="font-mono text-[0.875em]">data-novi-color</code> で染料を選ぶと、primary
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">
          <code className="font-mono text-[0.9em]">size</code> は幅ではなく最大高です
        </h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          全幅のシートに幅の段階は存在しないので、Modal の{' '}
          <code className="font-mono text-[0.875em]">size</code> は
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-medium tracking-tight">押すと沈みます</h2>
        <p className="max-w-[40rem] text-base leading-[1.9] text-site-muted">
          対話要素は押下中に 0.97 倍に縮み、<code className="font-mono text-[0.875em]">solid</code>{' '}
          では影が消えます。持ち上がっていた面が沈むという一連の動きで手応えを返します。
          <code className="font-mono text-[0.875em]">scale</code>{' '}
