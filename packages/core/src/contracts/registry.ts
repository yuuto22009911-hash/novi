...
import { comboBoxRequiredSlots, comboBoxSlots } from './combo-box.contract'
import { datePickerRequiredSlots, datePickerSlots } from './date-picker.contract'
...
export const NOVI_CONTRACTS = {
  ...
  ComboBox: { slots: comboBoxSlots, required: comboBoxRequiredSlots },
  DatePicker: { slots: datePickerSlots, required: datePickerRequiredSlots },
