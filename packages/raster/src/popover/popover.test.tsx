...
describe('Popover: Raster のデザイン規律', () => {
  it('arrow slot を描画しない（任意 slot 省略の実例・FR-13）', () => {
    ...
    const result = checkSlotContract(baseElement, NOVI_CONTRACTS.Popover)

    expect(result.found).not.toContain('arrow')
    // 任意 slot なので描画しなくても契約違反にならない
